...
public class OreVeinElementReader extends
    ...
    public ArrayList<RightClickOption> getRightClickOptions(final OreVeinElement element,
        ...
        rightClickOptions.add(new RightClickOption("button.gtpm.toggle_waypoint.name", 0, target) {
        ...
        rightClickOptions
                .add((new RightClickOption("button.gtpm.mark_as_depleted.name", rightClickOptions.size(), target) {
