...
public class EnergyContainerList {
    ...
    /** The highest single energy container's voltage in the list. */
    @Getter
    ...
    public EnergyContainerList(List<? extends IEnergyContainer> energyContainerList) {
        this.energyContainers = energyContainerList.toArray(IEnergyContainer[]::new);
