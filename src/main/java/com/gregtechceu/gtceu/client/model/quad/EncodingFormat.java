...
public class EncodingFormat {
    ...
    static Direction lightFace(long bits) {
        Direction face = GeometryHelper.faceFromIndex((int) ((bits >> LIGHT_SHIFT) & DIRECTION_MASK));
        if (face == null) {
            throw new IllegalStateException("Light face bits do not encode a direction");
        }
        return face;
    }
