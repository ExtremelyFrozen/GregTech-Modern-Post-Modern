...
object MachineControllerCoverConfigActions {
    ...
    @JvmStatic
    fun createSetConfigAction(
        controllerMode: ControllerMode?,
        minRedstoneStrength: Int,
        inverted: Boolean,
        preventPowerFail: Boolean,
    ): SyncActionData {
    ...
    private data class Config(
        ...
        val minRedstoneStrength: Int,
        val inverted: Boolean,
        val preventPowerFail: Boolean,
    )
    ...
    private fun target(context: SyncActionContext): MachineControllerCoverConfigActionTarget =
        context.holder as? MachineControllerCoverConfigActionTarget
