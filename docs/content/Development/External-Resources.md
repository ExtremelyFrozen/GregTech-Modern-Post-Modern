...
# :material-link-box-variant: 外部资源

本页汇总了一些外部文档链接，覆盖开发相关的多个主题，也包含其他可能有帮助的资源。


## 通用 Modding 文档

!!! link "Forge / NeoForge 官方文档"
...
!!! link "Mixin 使用概览"
    ...
    这是开始学习如何使用 mixin 的优秀资源；当你需要查找某个具体操作时，它也适合作为快速参考。

    请注意，这些内容并不只适用于 Fabric，而是适用于所有平台。
...
!!! link "Architectury Gradle Plugin"
    ...
    请注意，我们只使用 Architectury 的构建系统，而不是 Architectury 库本身。
